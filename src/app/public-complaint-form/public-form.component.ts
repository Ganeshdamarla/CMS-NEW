...
export class PublicFormComponent implements OnInit {
  ...
  leftColumnFields: FormField[] = [
    ...
    { label: 'District', name: 'District', type: 'dropdown', options: ['Guntur', 'Chittoor', 'Prakasham', 'Krishna'], readonly: false, disabled: false },
    { label: 'Mandal', name: 'Mandal', type: 'dropdown', options: ['Vinukonda', 'Puttur', 'Guntur', 'Tenali', 'Sattenapalli'], readonly: false, disabled: false },
    { label: 'Village', name: 'Village', type: 'dropdown', options: ['Vinukonda', 'Puttur', 'Nuzendla', 'Bollapalli'], readonly: false, disabled: false },
